...
import { SendRounded, ViewAgendaRounded } from "@mui/icons-material";
            ...
            <CreatorPageContainer>
                ...
                <ChatsWindowOuterContainer>
                    <UserListContainer>
                        Group Members
                        <UserCard onClick={() => {
                            setWhomToSend(groupInfo.chatId);
                        }}>Group Chat</UserCard>
                        {
                            groupInfo.members && groupInfo.members.map((member) => {
                                if(member.wallet.substring(7) === state.user.walletAddress){
                                    return <></>
                                }
                                return <UserCard onClick={() => {
                                    setWhomToSend(member.wallet);
                                }}>{member.wallet.substring(7, 12)}..
                                {member.wallet.slice(-5)}{" "}</UserCard>
                            })
                        }
                    </UserListContainer>
                    <ChatsWindow>
                                ...
                                {chatsList.map((chat, index) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                <ChatAuthor>
                                                {chat.walletAddress.substring(0, 7)}..{chat.walletAddress.slice(-5)}
                                                </ChatAuthor>
                                                {chat.messageContent}
                                                <ChatTime>
                                                    {moment(
                        ...
                        <ChatsMessageInputContainer>
                            ...
                            <ChatSendBtn onClick={() => {
                                ...
                                <ViewAgendaRounded style={{ color: "white" }} />
                            </ChatSendBtn>
                            <ChatSendBtn onClick={() => {
                                sendPushMessage(whomToSend, chatBody);
                            }}>
